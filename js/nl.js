...
function config(results) {
  ...
  $('#mainGrid').append('<div id="s'+i+'" class="slats"><a target="_blank" href="' + d.link + '"><img alt="'+ d.name +'" src="'+ d.media +'" /></a><div class="projectLabel"><span class="dateline">'+ d.date +'</span><span class="pName"> - '+ d.name +'</span></div></div>')
